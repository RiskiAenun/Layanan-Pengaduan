                ...
                <div class="card-body">
                    <form action="{{ route('laporan.getLaporan') }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="text" name="form" class="form-control" placeholder="Tanggal Awal"
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        @if ($pengaduan ??'')
                            <a href="{{ route('laporan.cetakLaporan', ['form' => $form, 'to' => $to]) }}" class="btn btn-danger">Export PDF</a>
                        @endif
                    </div>
                </div>
                <div class="card-body">
